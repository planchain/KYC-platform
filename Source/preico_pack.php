...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#custometh").change(function(){
				
				var $myEthamount = parseFloat($(this).val()).toFixed(8);
				var dataString = 'eth='+$myEthamount;
				$.ajax({
	...
	<section id=main>
		<div class=content>
			<?php	
				// Server side code has been deleted for security reasons and will be added after crowdsale
			?>
			<form id="preico-form" method="post" class="form">
				<input type="hidden" name="package" id="package" value="" />
				<input type="hidden" name="ethamount" id="ethamount" value="" />
			</form>
			<div class="grid center">
				...
				<div class="row">
					<h3 class="txt-highlight">TOKEN PRE-ICO</h3>
				</div>
				<div class="row">
					<h2>PRE-ICO SHA Digital Assets Packages</h2>
				</div>
				<div class="row">
					<p>
						Choose your SHA Digital Assets Package:
					</p>
				</div>
				<?php	
					// Server side code has been deleted for security reasons and will be added after crowdsale
				...
				<div class="row" style="margin-top: 30px;">
					<b>
						*Disclaimer: Note: The purchase plan selected is not final sale, as prices constantly fluctuate. The purchase plan <br>is an estimated amount, the final SHA amount will be calculated once you click "Register Transaction" in the next step.<br>
						<?php echo $currentUSDts; ?> - Last ETH price: <?php echo number_format($currentUSD,4). " USD"; ?>
					</b>
				</div>				
			</div>
		</div>
