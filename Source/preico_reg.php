...
<head>
    ...
    <title>SAFE HAVEN - Account | PRE-ICO SHA Digital Assets Packages</title>
	...
	<link rel="stylesheet" type="text/css" href="css/presale.css">
...
<body>
    ...
    <section id="legal-header">
        ...
        <h1>PRE-ICO SHA Digital Assets Packages</h1>
    </section>
	<section id=main>	
		<div class=content>
			<?php	
			...
			<div class="dropdown show">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
					<a class="dropdown-item disabled" href="#"><?php echo $username; ?></a>
					<a class="dropdown-item" href="./account">Contributions</a>
					<a class="dropdown-item" href="./logout.php">Logout</a>
				</div>
			</div>
			<br>
			<hr style="width: 100%; color: black; height: 1px; background-image: linear-gradient(241deg, #ab2cdf 25%, #2ca5df 100%);" />
			<div class="main-left left">
				<h3 class="txt-highlight">SAFE HAVEN PRE-ICO</h3>
                <h2>Official Safe Haven ETH-address</h2>
				<br>
				<b>This video confirms that the ETH address is ours. If the address in the video does not match, do not send any ETH to the address, your funds will be lost!</b><br>
				<h3 class="txt-highlight warning blink_me">
					Important!! Every other address is a scam!
				</h3>
				<br>
				...
				<br>
				<br>
				<h2>Guidelines Pre-Sale Participation</h2>				
				<h3 class="txt-highlight">STEP 1:</h3>
				<p>
					Send Ethereum from your choice to our official Safe Haven ETH address.<br>
					<h3 class="txt-highlight warning">
						Important!! Only send funds from your ERC-20 wallet<br>
						For example: <a href="https://www.myetherwallet.com/" onclick='track("Pre-Sale/MyEtherWallet link", {placement: "Pre-Sale/Main"})'>https://www.myetherwallet.com/</a>
					</h3>					
				</p>
				<br>
				<h3 class="txt-highlight">STEP 2:</h3>
				<p>
					Register your contribution by complete all the details in the form and submit.					
				</p>
				<br>
				<h3 class="txt-highlight">STEP 3:</h3>
				<p>
					Go back to your account and see if your transaction is confirmed and approved.<br>
					Be aware that the confirmation process can take several hours.
				</p>
				<br>
            </div>
            <div class="main-right preicoreg">
				<form id="preico-form" method="post" autocomplete="off">
					<div class="input-container">
						<h2>Become an early contributor and get 33% bonus</h2>
						<p>
							Dear <?php echo $username; ?>,<br>
							<br>
							Congratulations, you choosed the <span class="package"><?php echo $arrPackage[0]; ?></span>.<br>
							<h3 class="txt-highlight warning">
								Don't forget to fill in the form below and submit your transaction by clicking the submit button.
							</h3>
							<br>
							PRE-ICO IS OPEN FROM (GMT):<br>
							24/02/2018 5PM - 11/03/2018 5PM<br>
							<br>
							<h6>ETH Address Safe Haven</h6>
							Click with the <b><u>left mouse button</u></b> to copy the ETH address to the clipboard!<br>
							<br>
							<span class="ethaddress" data-clipboard-text="<?php echo $ethaddress; ?>"><?php echo $ethaddress; ?></span>
							<h3 class="txt-highlight warning blink_me">
								Important!! IF GWEI is greater than 50, you will be validated LAST!<br>
								Use a GWEI lower or equal than 50 and GAS LIMIT 21000 is ok.
							</h3>
							<br>								
							<span class="blink_me"><b>Please check if the following ETH address is the one you send from. Otherwise change it to the one you send from.</b></span>
							<br>
							<p>Ethereum Address</p>
							<?php
							if(isset($ethaddressUser)){
								$ethAddressText = "value='".$ethaddressUser."'";
							}
							?>
							<input type="text" name="txtethaddress" required <?php if(isset($ethAddressText)) echo $ethAddressText; ?> />
							<p>Ether amount</p>
							<?php	
							// Server side code has been deleted for security reasons and will be added after crowdsale
							?>
							<input type="number" name="txtethamount" id="txtethamount" required min="0.10000000" step="0.00000001" <?php echo $ethValueText; ?>" autocomplete="false"/>
							<p>Transaction ID - TxHash - TxID</p>
							<input type="text" name="txtethtxid" required value="" />
							<br>
							<br>
							<div id="html_element"></div>
							<br>
							
							<button class="submit disabled" type="submit" id="but" name="btn-submit" disabled>Submit</button>
							<input type="hidden" id="id" name="id" value="<?php echo $userID; ?>" /><br>
							<br>
