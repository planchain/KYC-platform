...
<head>
    ...
    <title>SAFE HAVEN - Account</title>
	...
	<section id=main>		
		<div class=content>
			...
			<div class="container">
				...
				<p>
					<i>
						* Please be patient in order to have your transaction validated, this process could take several days.<br>
						** Referral bonus is final when all transactions have been validated.<br>
						*** Referral program will be closed when bonus cap is reached.</i></p>
			</div>	
		</div>
    </section>
    <section id="connect">
